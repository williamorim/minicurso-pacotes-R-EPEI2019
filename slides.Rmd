...
---
class: middle, center
### Vamos criar o pacote "pastePlus"

```{r, eval=FALSE}
usethis::create_package(path = "~/Desktop/pastePlus")
```
---
...
Vamos criar o arquivo `R/plus.R`.
...
Nesse arquivo, vamos redefinir o operador `+` para concatenar strings.
